      ...
      <div className="mx-auto max-w-7xl pb-16">
        {
          <MobileView>
            ...
            <div className="flex px-6 pt-6">
              <PoweredBy
                className="font-body text-sm font-semibold text-darkgrey"
                translations={{
                  searchBy: "Powered by",
                }}
              />
        ...
        <BrowserView>
          <div className="z-100 relative my-12 w-full px-6 lg:my-16">
            <RegionFilter
              attribute="county"
              limit={100}
              transformItems={(items) => persistantOrder(items)}
            />
            <PoweredBy
              className="absolute right-0 top-0 font-body text-sm font-semibold text-darkgrey"
              translations={{
                searchBy: "Powered by",
              }}
            />
        ...
        <div className="mb-12 flex flex-row lg:my-16">
